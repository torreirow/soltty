...
- **Logo**: the project no longer ships a logo
  - It rendered "SOLIDTIME" in its wordmark, which is branding use of another
    project's name rather than descriptive reference
  - The provenance of its photographic background was never recorded
  - `logo-prompt.md` is kept as a brief for a future, clean replacement
...
- **Enhanced list output**: List command now shows entry IDs and project names by default
  - New ID column shows first 8 characters of UUID (e.g., "a1b2c3d4")
