...
soltty start -y "New task" --project "Acme-General"
```
...
soltty toggle --description "General. Tasks" --project "Acme-General"
```
...
```json
{"running":true,"id":"a1b2c3d4-...","description":"General. Tasks","project":"Acme-General","elapsed":"2h 15m","start":"2026-06-25T10:32:00Z"}
```
...
------------------------------------------------------------------------------------------
a1b2c3d4 | 2026-04-09 | 14:30 | 2h 15m   | Customer       | Working on feature X
...
soltty list projects --json --client "Acme"
```
