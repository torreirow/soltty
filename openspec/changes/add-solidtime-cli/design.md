...
- Must work with self-hosted Solidtime instance at `app.example.com`
...
**Pattern:**
```
solidtime-cli start "Working on feature X" --project "Example-Project"
solidtime-cli stop
solidtime-cli current
solidtime-cli add "Meeting" --start "14:00" --end "15:30" --project "Acme-Meetings"
