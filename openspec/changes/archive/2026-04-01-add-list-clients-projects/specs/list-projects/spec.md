...
- **WHEN** client "Acme Corp" has projects "Meetings", "General", "Admin"
...
- **WHEN** user runs `soltty list projects -c "Acme Corp"`
...
- **THEN** the system displays projects for "Acme Corp" (case-insensitive match)
...
- **WHEN** user runs `soltty list projects -c "Tech"` and both "Acme Corp" and "BioTech" exist
