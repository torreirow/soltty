...
```go
const baseURL = "https://app.example.com/api/v1"
```
...
For Acme Corp Cloud, use: https://app.example.com/api/v1
...
1. **Required**: Add `base_url` field to existing config.json
   - For Acme Corp Cloud: `"base_url": "https://app.example.com/api/v1"`
   - For self-hosted: use your instance URL
