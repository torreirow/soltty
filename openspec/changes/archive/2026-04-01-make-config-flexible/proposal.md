...
Currently, the Solidtime API endpoint (`https://app.example.com/api/v1`) is hardcoded in the Go source code, making it impossible to:
...
- **Migration**:
  ...
  - Example migration: add `"base_url": "https://app.example.com/api/v1"` to config
