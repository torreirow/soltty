...
- **WHEN** user runs `solidtime-cli continue a1b2c3d4`
- **AND** an entry with UUID starting with "a1b2c3d4" exists
...
- **AND** suggest: "Please use more characters (e.g., 'a1b2c3d4')"
...
- **AND** show example: "Example: a1b2c3d4"
- **AND** exit with code 1
...
- **AND** show example: "Example: soltty continue a1b2c3d4"
- **AND** exit with code 1
