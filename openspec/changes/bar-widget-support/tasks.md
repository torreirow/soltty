...
- [x] 4.4 Verify `soltty list projects --json --client "Acme"` filters correctly
...
- [x] 6.9 Verify `soltty toggle --description "Task" --project "Acme-General"` starts new timer when no entries exist
